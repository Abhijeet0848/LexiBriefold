...
def test_nlp_readability_and_keyword_accuracy():
    ...
    extracted_kw_names = [k["keyword"] for k in keywords]
    assert any(k in ["intelligence", "artificial", "summarization", "document", "lexibrief", "transformer"] for k in extracted_kw_names)
